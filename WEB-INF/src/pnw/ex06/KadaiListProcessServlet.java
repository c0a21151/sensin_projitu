...
/**
 * Point: ex06の中にある，KadaiListProcessServletという名前で
 * マッピングされるように，WebServlet内を埋めて下さい．
 */
@WebServlet("/ex06/KadaiListProcessServlet")
public class KadaiListProcessServlet extends HttpServlet {

    /**
     * @see HttpServlet#HttpServlet()
     */
    public KadaiListProcessServlet() {
        super();
