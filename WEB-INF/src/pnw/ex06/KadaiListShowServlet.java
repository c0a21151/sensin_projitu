...
/**
 * Point: ex06の中にある，KadaiListShowServletという名前でマッピングされるように，WebServlet内を埋めて下さい．
 */
@WebServlet("/ex06/KadaiListShowServlet")
public class KadaiListShowServlet extends HttpServlet {
